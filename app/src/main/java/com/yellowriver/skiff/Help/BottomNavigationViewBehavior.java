 ...
 * @since V4.0.0
 */
class BottomNavigationViewBehavior extends CoordinatorLayout.Behavior<View> {
    ...
    public boolean onDependentViewChanged(@NotNull CoordinatorLayout parent, @NotNull View child, @NotNull View dependency) {
        //得到依赖View的滑动距离
        int top = ((AppBarLayout.Behavior) Objects.requireNonNull(((CoordinatorLayout.LayoutParams) dependency
